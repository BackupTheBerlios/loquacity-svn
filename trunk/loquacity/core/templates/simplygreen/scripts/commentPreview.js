//I did not write this code, but borrowed in from Mark (http://www.diveintomark.com). Thank you
...
function updateLivePreview() {
	...
	var cmntArea = document.getElementById('text');
	...
	if(purl && pnme) {
        ...
        document.getElementById('commentPreview').innerHTML = '<h3>Comment preview</h3><p>' + cmnt + '</p>';
}
