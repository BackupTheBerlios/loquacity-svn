 ...
 * @package Loquacity
 * @subpackage Plugins
 * @author Andr� Rabold, Nathan Codding, The PHPBB group
 * @copyright &copy; 2003  Andr� Rabold, Nathan Codding, The PHPBB group
...
function identify_modifier_bbcode () {
  ...
  return array (
    ...
    'authors'         =>'Andr� Rabold, Nathan Codding, The PHPBB group',
    'licence'         =>'GPL',
    'help'            => $help
  );
}
...
function smarty_modifier_bbcode($message) {
  $preg = array(
    ...
    '/\[list=1(?::\w+)?\](.*?)\[\/list(?::\w+)?\]/si'         => "<ol class=\"ng_list_dec\">\\1</ol>",
    '/\[list=i(?::\w+)?\](.*?)\[\/list(?::\w+)?\]/s'          => "<ol class=\"ng_list_lroman\">\\1</ol>",
    '/\[list=I(?::\w+)?\](.*?)\[\/list(?::\w+)?\]/s'          => "<ol class=\"ng_list_uroman\">\\1</ol>",
    '/\[list=a(?::\w+)?\](.*?)\[\/list(?::\w+)?\]/s'          => "<ol class=\"ng_list_lapha\">\\1</ol>",
    '/\[list=A(?::\w+)?\](.*?)\[\/list(?::\w+)?\]/s'          => "<ol class=\"ng_list_ualpha\">\\1</ol>",
    '/\[list(?::\w+)?\](.*?)\[\/list:o(?::\w+)?\]/s'          => "<ol class=\"ng_list_dec\">\\1</ol>",
